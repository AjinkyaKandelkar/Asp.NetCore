...
using MyTraining1121AngularDemo.Web.UiCustomization.Metronic;
using System.Threading.Tasks;
using Abp;

namespace MyTraining1121AngularDemo.Web
{
    public class ThemeXUiCustomizer : UiThemeCustomizerBase, IUiCustomizer
    {
        public ThemeXUiCustomizer(ISettingManager settingManager) : base(settingManager, AppConsts.ThemeDefault)
        {
