...
namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var customerBook = pages.CreateChildPermission(AppPermissions.Pages_Tenant_CustomerBook , L("Customer"), multiTenancySides: MultiTenancySides.Tenant);
            customerBook.CreateChildPermission(AppPermissions.Pages_Tenant_CustomerBook_CreateCustomer, L("CreateNewCustomer"), multiTenancySides: MultiTenancySides.Tenant);
            customerBook.CreateChildPermission(AppPermissions.Pages_Tenant_CustomerBook_DeleteCustomer, L("DeleteCustomer"), multiTenancySides: MultiTenancySides.Tenant);
            customerBook.CreateChildPermission(AppPermissions.Pages_Tenant_CustomerBook_EditCustomer, L("EditCustomer"), multiTenancySides: MultiTenancySides.Tenant);
