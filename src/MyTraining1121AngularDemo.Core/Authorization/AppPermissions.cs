namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        //Relted to Customerbook
        public const string Pages_Tenant_CustomerBook = "Pages.Tenant.CustomerBook";
        public const string Pages_Tenant_CustomerBook_CreateCustomer = "Pages.Tenant.CustomerBook.CreateCustomer";
        public const string Pages_Tenant_CustomerBook_DeleteCustomer = "Pages.Tenant.CustomerBook.DeleteCustomer";
        public const string Pages_Tenant_CustomerBook_EditCustomer = "Pages.Tenant.CustomerBook.EditCustomer";
    }
}
