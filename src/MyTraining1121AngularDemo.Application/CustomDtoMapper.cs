...
namespace MyTraining1121AngularDemo
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<Person, GetPersonForEditInput>();
            configuration.CreateMap<Person, GetPersonForEditOutput>();
            configuration.CreateMap<Person, EditPersonInput>();

            configuration.CreateMap<Customer, CustomerListDto>();
            configuration.CreateMap<Customer, GetCustomerInput>();
            configuration.CreateMap<CreateCustomerInput, Customer>();
            configuration.CreateMap<Customer, EditCustomerInput>();
            configuration.CreateMap<Customer, GetCustomerForInput>();
            configuration.CreateMap<Customer, GetCustomerForOutput>();

            configuration.CreateMap<CustomerUsers, CustomerUserListDto>();
            configuration.CreateMap<CustomerUsers, GetCustomerUserInput>();
            configuration.CreateMap<CreateCustomerUserInput, CustomerUsers>();
