...
using MyTraining1121AngularDemo.Migrations;
...
namespace MyTraining1121AngularDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MyTraining1121AngularDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MyTraining1121AngularDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{MyTraining1121AngularDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{MyTraining1121AngularDemoConsts.ConnectionStringName}", constring);
        }
